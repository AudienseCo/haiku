...
function Component(env) {
  ...
  this.fileTag = function(context, file, options) {
    ...
    return new nunjucks.runtime.SafeString(env.render('partial/component.html', options));
  }
  ...
  this.blockTag = function(context, body) {
    context['code'] = body();
    return new nunjucks.runtime.SafeString(env.render('partial/component.html', context));
  }
}
